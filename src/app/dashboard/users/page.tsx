    ...
    <div className="p-6 max-w-4xl mx-auto space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Kelola akun karyawan & akses sistem</p>
        </div>
            ...
            {users?.map((u: any) => {
              ...
              return (
                <tr key={u.id} className="hover:bg-slate-50">
                  ...
                  <td className="td text-slate-400 text-sm">{formatDate(u.createdAt)}</td>
                  <td className="td text-center">
                    <button
                      onClick={() => {
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div className="flex items-center justify-between p-5 border-b border-slate-100">
              <h2 className="font-display font-semibold text-slate-800">Tambah User</h2>
